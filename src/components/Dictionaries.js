...
export {month,day_of_week,accident_area,day_of_week_claimed,month_claimed,sex,marital_status,fault,policy_type,vehicle_category,vehicle_price,past_no_claims,age_of_vehicle,police_report_filed,witness_present,no_of_supplements,address_change_claims,base_policy }