...
function ClaimData() {
  const imageUrl =
    "https://previews.123rf.com/images/arrow/arrow1505/arrow150500022/40383202-insurance-background.jpg"; // Replace with your image path
          ...
          <form onSubmit={claim_details}>
            ...
            <div className="upload-container">
              ...
              <div className="upload3">
                <label>Upload Damage Car Photo</label>
                <input type="file" className="upload-btn" />
              </div>
            </div>
